...
const FarmerPhotoUpload = ({navigation}) => {
 ...
 <Header backTitle />
        ...
        <Text mtmedium gray h5 marginVertical={5} >Make sure farmers photo is not blurry.</Text>
          ...
          />
            ...
            <Text h6 gray>Is this clear enough?</Text>
            <Text paddingHorizontal={80} marginTop={10} small center muted>Make sure your face is clear enough and the photo is not blurry</Text>
            </Block>
            </Block>
            ...
            <Text white center h6>Yes use this one</Text>
          </Button>
            </Block>
            <Block flex={0}>
            <Button secondary>
            <Text white center h6>Retake photo</Text>
          </Button>
            </Block>
        </Block>
